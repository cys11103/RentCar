		...
		<h3>기본 정보</h3>
			<table>
				...
				<tr>
					...
					<td><input type="hidden" name="reid"><input
						type="button" value="중복체크" onclick="return id_check()"></td>
				</tr>
				<tr>
					<td>비밀번호</td>
				</tr>
				...
				<tr>
					<td>영문이름</td><td style="text-align: right;">*여권이름과 동일하게 입력</td>
				</tr>
				<tr>
					<td><input type="text" name="ename1" placeholder="성"></td><td><input type="text" name="ename2" placeholder="이름"></td>
				</tr>
				<tr>
					<td>휴대전화</td>
				</tr>
				<tr>
					<td><input type="text" name="phone" placeholder="-를 넣어주세요"></td>
				</tr>
				<tr>
					<td>E-mail</td>
				</tr>
...
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
			...
			<br>
			<input type="checkbox" name="agree1">서비스 이용 약관에 동의합니다.
			<br><br>
			<textarea rows="10" cols="70">
개인정보 수집 및 처리방침에 대한 안내

(주)네이처모빌리티(이하‘찜카’라 한다)는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립․공개합니다. 
제 1 조(개인정보의 처리목적)
...
2.재화 또는 서비스 제공
물품배송, 서비스 제공, 계약서․청구서 발송, 콘텐츠제공, 맞춤서비스 제공, 본인인증, 연령인증, 요금결제․ 정산, 채권추심 등을 목적으로 개인정보를 처리합니다. 
3. 고충처리
민원인의 신원 확인, 민원사항 확인 사실조사를 위한 연락․ 통지, 처리결과 통보 등의 목적으로 개인정보를 처리합니다.
4. 마케팅 및 광고에 활용
인구통계학적 특성에 따른 서비스 제공 및 광고 게재, 웹페이지 접속 빈도 파악, 예약결제서비스 및 기타 상품 및 서비스의 이용실적 분석, 경품행사 이벤트 등 광고성 정보 전달 또는 회원 참여 공간 운영, 고객대상 설문조사 및 서비스 및 상품안내의 목적으로 개인정보를 처리합니다. 
5. 규정이 있는 경우 또는 수사기관 행정기관이 법원의 허가서와 함께 요청한 경우에만 내부 절차를 거쳐 최소한의 정보가 동의 없이 제공될 수 있습니다.
제2조 (개인정보의 처리 및 보유기간)
...
제3조(개인정보의 제3자 제공)
① 회사는 정보주체의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우에만 개인정보를 제 3자에게 제공합니다. 
② 회사는 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
- 개인정보를 제공받는 자 : 제주콜렌트카, 더세븐렌트카, 발리렌트카, 제주씽씽렌트카, 레인보우모빌리티, 아우토젠, 스마일렌트카, 제주다움렌트카, 제주아산렌트카, 올레렌트카, 씨유렌트카
- 제공받는 자의 개인정보 이용목적 : 렌트카 대여 예약자 정보 제공 
- 제공하는 개인정보 항목 : 예약자 및 운전자 정보제공
- 제공받는 자의 보유․이용기간 : 렌트카 이용 결제계약에 따른 거래기간동안 
...
2. 재화 또는 서비스 제공
․필수항목: 운전자 명, 운전자 생년월일, 운전자 전화번호, 면허종류, 신용카드 번호, 유효기간 
3. 인터넷 서비스 이용과정에서 아래 개인정보 항목이 자동으로 생성되어 수집될 수 있습니다.
․IP주소, 쿠키, MAC주소, 서비스 이용기록, 방문기록, 불량 이용기록 등
			</textarea>
		<br>
		<input type="checkbox" name="agree2">개인정보 수집 및 처리방침에 동의합니다.
		<br><br>
